...
public class BoardVO {
	...
	private String board_file; //원본파일명
	private String board_realfile; //실제 업로드 될 파일명
	private int board_re_ref; //원본글번호
	...
	public String toString() {
		return "BoardBean [board_num=" + board_num + ", board_name=" + board_name + ", board_pass=" + board_pass
				...
				+ ", board_realfile=" + board_realfile + ", board_re_ref=" + board_re_ref + ", board_re_lev="
